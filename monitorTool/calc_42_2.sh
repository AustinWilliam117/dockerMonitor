...
# 初始服务数组
server_array=("nlu_service_pbcc" "nlu_service_pbcc_bak" "dm_pbcc42" "dm_pbcc42_copy" "pbee_pbcc42" "pbee_pbcc42_copy" "audiolistening_42" "audiolistening_42_1" "push-kafka_1" "push-kafka_2" "redis-proxy_2" "redis-proxy_1" "sms-management_4_2" "sms-management_4_2_1")
